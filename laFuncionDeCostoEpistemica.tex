...
\onslide<6->{Con frecuencia $p = \lim_{T \rightarrow \infty} n_c/T$}
\end{frame}
...
\includegraphics[width=0.6\textwidth, page=4]{figures/tasa-temporal2.pdf} 
\end{textblock}
}
...
\only<7->{
\begin{textblock}{160}(0,46) \centering
\Large Con el resultado de las apuestas hacemos inferencia! \\[0.4cm]


\onslide<8>{Más aún, la inferencia Bayesiana es un juego de apuestas!}
\end{textblock}
}
