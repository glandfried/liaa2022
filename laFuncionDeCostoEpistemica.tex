...
\textcolor{black!85}{\rotatebox[origin=tr]{-0}{\scalebox{3}{\bet}}}
\end{textblock}
\begin{textblock}{160}(0,38) \centering
\textcolor{black!85}{\rotatebox[origin=tr]{3}{\scalebox{3}{$p$}}}
\end{textblock}
...
% 
% \includegraphics[width=0.65\textwidth]{auxiliar/images/output/cisma.png}  
% 
% \end{frame}
...
\begin{textblock}{155}(02.5,20)
 \centering
\includegraphics[width=0.49\textwidth]{auxiliar/images/chaco1984.jpg}
\includegraphics[width=0.49\textwidth]{auxiliar/images/chaco2022.jpg}
\end{textblock}
...
%  \centering
% \includegraphics[width=0.49\textwidth]{auxiliar/images/brasil1986.jpg}
% \includegraphics[width=0.49\textwidth]{auxiliar/images/brasil2020.jpg}
% \end{textblock}
% 
% \end{frame}
% 
...
% \includegraphics[width=1\textwidth]{auxiliar/images/utt}
